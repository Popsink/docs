...
IBMi/AS400 and currently have no system to connect to, please head to [this page](db2_setup), follow the instructions
...
It's a vital step to capture changes from the source databases with no additional overhead. Please head to [journaling](journaling),
