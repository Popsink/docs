...
![image](/images/pub400_signup.png)
...
you'll need the terminal to enable [journaling](journaling) on your source tables.
...
![image](/images/dsplibl.png)

Now the result will look like this

![image](/images/dsplibl_result.png)
...
In our next step, we will use the terminal to configure our source tables with [journaling](journaling) enabled.
