...
> This deployment model is intentionally simple. For high-availability or large-scale production use, see the [Kubernetes deployment](/deployment/selfhosted) instead.
...
For production-grade scalability and high availability, consider the [Kubernetes deployment](/deployment/selfhosted).
