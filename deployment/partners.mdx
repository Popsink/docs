...
first time, follow
[Install the data plane on Kubernetes](/deployment/selfhosted) instead — it walks
...
[Standalone](/deployment/control-data-plane#standalone-no-control-plane-at-all)
...
in [step 4 of the install guide](/deployment/selfhosted#4-configure-ingress).
...
<CardGroup cols={2}>
  <Card title="Install the data plane on Kubernetes" icon="cloud-arrow-up" href="/deployment/selfhosted">
  ...
  <Card title="Kubernetes requirements" icon="server" href="/deployment/installation">
