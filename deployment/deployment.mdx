---
title: Popsink Deployment Options
---
...
<CardGroup cols={2}>
  <Card title="Kubernetes, with Helm" icon="cloud-arrow-up" href="/deployment/selfhosted">
...
is documented in
[Control plane and data plane](/deployment/control-data-plane); air-gapped
installs run with no control plane at all.

<CardGroup cols={2}>
  <Card title="Kubernetes requirements" icon="list-check" href="/deployment/installation">
