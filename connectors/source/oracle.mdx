...
| **Capture method** | LogMiner, reading the online redo and archived redo logs |
...
<Note>Oracle 12c and 11g are not supported. On 23ai and 26ai, capture is available through LogMiner only.</Note>
