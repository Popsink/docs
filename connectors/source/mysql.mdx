...
| **Binary log** | Row-based — `binlog_format=ROW`, `binlog_row_image=FULL` |
| **Managed services** | Amazon RDS & Aurora MySQL, Google Cloud SQL, Azure Database for MySQL |
| **CDC engine** | Debezium 3.5 |

<Note>MySQL 5.7 has reached end of life and is not supported. MariaDB is a separate product and is not covered by this connector.</Note>
