...
| | |
|---|---|
| **ClickHouse** | ClickHouse Cloud and self-managed servers |
| **Table engine** | `ReplacingMergeTree` for incremental updates and deletes |
| **Protocol** | HTTPS interface — port `8443` on ClickHouse Cloud |
