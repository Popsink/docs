...
| | |
|---|---|
| **Apache Hudi** | Copy-on-Write and Merge-on-Read tables |
| **Compatibility** | Confirmed per deployment |

<Note>Supported Hudi and query-engine versions are validated with you before deployment — get in touch with your stack details.</Note>
