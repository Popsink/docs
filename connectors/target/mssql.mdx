...
| **Driver** | Microsoft JDBC Driver 13.4 for SQL Server |

<Note>SQL Server 2016 works on a best-effort basis. SQL Server 2025 has not been validated yet.</Note>
...
- For cloud-hosted SQL Server (e.g., Azure SQL Database), ensure Popsink's [egress IPs](/deployment/connectivity/egress-ips) are allowlisted in the server firewall.
