...
| **Deployments** | Self-managed and Elastic Cloud |
| **Client** | Elasticsearch Java client 9.4 |

<Note>Elasticsearch 7.x and OpenSearch are not supported — the client speaks the 8.x/9.x REST API.</Note>
