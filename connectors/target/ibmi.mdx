...
| **Connectivity** | JTOpen (JT400) over the IBM i host servers, writing through JDBC |

<Note>IBM i 7.2 and earlier are out of IBM support and are not covered.</Note>
