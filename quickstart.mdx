...
<Steps>
  ...
  <Step title="Build your pipeline">
    ...
    2. Select the source and target created in the previous steps.
    3. Choose the collections, tables, or topics to replicate and adjust transformation settings.
    4. Enable alerting so Popsink notifies you about failures or latency.
    5. Save and start the pipeline.
  </Step>

  <Step title="Validate the data flow">
    - Inspect the pipeline dashboard to confirm that events are processed and delivered.
