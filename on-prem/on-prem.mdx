---
title: Popsink API Documentation - Easy Step-by-Step Guide
---

## Table of Contents

1. [What You Need to Know](#what-you-need-to-know)
2. [Step 1: Create a User](#step-1%3A-create-a-user)
3. [Step 2: Log In](#step-2%3A-log-in)
4. [Step 3: Create an Environment](#step-3%3A-create-an-environment)
5. [Step 4: Create a Team](#step-4%3A-create-a-team)
6. [Step 5: Add Team Members](#step-5%3A-add-team-members)
7. [Step 6: Create a Pipeline](#step-6%3A-create-a-pipeline)
8. [Step 7: Update a Pipeline](#step-7%3A-update-a-pipeline)
9. [Step 8: Start/Stop a Pipeline](#step-8%3A-start%2Fstop-a-pipeline)
