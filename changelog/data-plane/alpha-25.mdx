...
- Unify `JWT_SERVICE_ACCOUNT_SECRET` and `METRICS_EXPORTER_TOKEN` into a single `JWT_SECRET` per data-plane; remove the `serviceAccountSecret` from the chart ([#1922](https://github.com/Popsink/data-plane/pull/1922)).
